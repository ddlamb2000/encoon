...
func RunSystemTestPost(t *testing.T) {
	...
	t.Run("Create2ndSingleGrid", func(t *testing.T) {
		postStr := `{"rowsAdded":` +
			`[` +
			`{"text1":"Grid02","text2":"Test grid 02","text3":"Grid 02 generated by system test.","text4":"journal"}` +
			`]` +
			`}`
		responseData, code, err := runPOSTRequestForUser("test", "root", model.UuidRootUser, "/test/api/v1/"+model.UuidGrids, postStr)
		errorIsNil(t, err)
		...
		jsonStringContains(t, responseData, `"text1":"Grid02","text2":"Test grid 02","text3":"Grid 02 generated by system test.","text4":"journal"`)
	})
