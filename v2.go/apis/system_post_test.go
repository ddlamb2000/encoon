...
func RunSystemTestPost(t *testing.T) {
	...
	t.Run("UpdateNewRow", func(t *testing.T) {
		...
		var uuid string
		db.QueryRow("SELECT uuid FROM rows WHERE gridUuid = $1 and text01= $2", model.UuidGrids, "Grid01").Scan(&uuid)
	...
	t.Run("CreateNewandUpdateRowsInSingleGrid", func(t *testing.T) {
		...
		db.QueryRow("SELECT uuid FROM rows WHERE gridUuid = $1 and text01= $2", model.UuidGrids, "Grid01").Scan(&uuidGrid)
